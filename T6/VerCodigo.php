...
<html lang="en">
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">Tema 6</a>
        ...
        <?php
        show_source($filename = "Practica6.1_1_6.html");
        show_source($filename = "6_7.html");
        show_source($filename = "6_8.html");
        show_source($filename = "6_9.html");
        ?>
