...
<html lang="en">
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">Tema 3</a>
        ...
        <?php
        show_source($filename = "JuegoBarcos.html");
        show_source($filename = "Practica3.1.html");
        show_source($filename = "Practica3.2.html");
        ?>
